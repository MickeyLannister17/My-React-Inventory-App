...
function InventoryItems() {
  ...
  return (
    <div className=" max-w-[1640px] mx-auto h-[300px] border bg-primary overflow-scroll">
      <div className="flex flex-col justify-center items-center bg-primary mx-auto py-2">
        ...
        {inventoryItem.length < 1 ? (
          <div className="bg-primary justify-center items-center pt-5 mt-5 flex flex-col">
            <ImFilesEmpty color="white" size={60} />
            <h3 className="text-secondary text-left pt-4">
              Inventory is empty!
            </h3>
          </div>
        ) : (
